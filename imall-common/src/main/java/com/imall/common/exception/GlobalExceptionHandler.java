...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity handleThrowableException(Throwable e, HttpServletRequest request) {
        ...
        return this.getResponseEntity(request, e, ResultCode.INTERNAL_ERROR);
    }
    ...
    public ResponseEntity handleBusinessException(HttpMessageNotReadableException e, HttpServletRequest request) {
        return this.getResponseEntity(request, e, ResultCode.FAILED.getCode(), "请求不能为空", null);
    }
    ...
    public ResponseEntity handleBusinessException(ApiException e, HttpServletRequest request) {
        if (e.getErrorResult() == null) {
            return this.getResponseEntity(request, e, ResultCode.FAILED.getCode(), e.getMessage(), null);
        }
        return this.getResponseEntity(request, e, e.getErrorResult().getCode(), e.getErrorResult().getMessage(), null);
    }
    ...
    public ResponseEntity handlerValidationException(ConstraintViolationException e,
        ...
        log.warn("请求参数异常 {}", sb);
        return this.getResponseEntity(request, e, ResultCode.REQUEST_PARAMETER_EXCEPTION);
    }
    ...
    public ResponseEntity handlerBindException(BindException e, HttpServletRequest request) {
        ...
        log.warn("请求参数异常 {}", sb);
        return this.getResponseEntity(request, e, ResultCode.REQUEST_PARAMETER_EXCEPTION.getCode(), sb.toString(), null);
    }

    protected ResponseEntity getResponseEntity(HttpServletRequest request, Throwable e) {
        return this.getResponseEntity(request, e, ResultCode.REQUEST_TYPE_MISMATCH);
    }

    protected ResponseEntity getResponseEntity(HttpServletRequest request, Throwable e, ResultCode ResultCode) {
        return this.getResponseEntity(request, e, ResultCode.getCode(), ResultCode.getMessage(), null);
    }
    ...
    protected <T> ResponseEntity getResponseEntity(HttpServletRequest request, Throwable e, int code, String msg, T data) {
        ...
        CommonResult<T> commonResult = CommonResult.failed(code, msg, data);
