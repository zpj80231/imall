...
public class IpUtil {
     ...
     * # 	示例：<br/>
     * #	> 1.168.1.1    			设置单个IP的白名单<br/>
     * #	> 192.*    			    设置ip通配符,对一个ip段进行匹配<br/>
     * #	> 192.168.3.17-192.168.3.38	设置一个IP范围<br/>
     * #	> 255.168.4.0/24		设置一个网段<br/>
     * ##
     * </p>
     * 类如：<br/>// 白名单跳过校验<br/>
     * String ipAddr = IpUtil.getIpAddr(request);<br/>
     * if(IpUtil.isPermited(ipAddr, ”127.0.0.1;192.168.*“)) {<br/>
     * ...<br/>
     * }
     *
     * @param ip
